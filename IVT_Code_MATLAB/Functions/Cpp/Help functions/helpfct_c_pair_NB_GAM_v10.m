function [loglik,grad] = helpfct_c_pair_NB_GAM_v10(y,par,Hvec,H,n,dt)
...
LebUnc = a*(1-(1+Hvec*dt/a).^(-HH))/HH;
LebCom = a*(1+Hvec*dt/a).^(-HH)/HH;
...
output = c_pair_grad_NB_GAM_v10(y,par,Hvec,H,n,dt,maxY,r_sum_unc,r_sum_com);
